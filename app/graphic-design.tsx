    ...
    <div>
      <div className=" p-4   mx-auto relative z-10  w-full pt-20 md:pt-32">
        ...
        <p className="mt-4 text-lg font-normal  text-neutral-300 max-w-lg text-center mx-auto">
          The belief of the organization is that, of all the factors negating
          security enterprises today, one of the prominent is low security
          awareness and gradual intentional apathy to security agents/agencies
          in Nigeria. The way out therefore, is by gradual raising of the
          security awareness and consciousness of Nigerians.
        </p>
